...
import com.example.firstproject.dto.ContentRequestDTO;
import com.example.firstproject.dto.ContentResponseDTO;
...
//            security = @SecurityRequirement(name = "JWT"), JWT가 필요할때
            parameters = {
                    @Parameter(
                            name = "id",
